...
namespace webapp.Controllers
{
    public class TenantController : Controller
    {
        ...
        public ActionResult SignUp()
        {
            ...
            // Redirigez vers la page de consentement d’Active Directory demandant des autorisations.
        ...
        public ActionResult SignUpCallback()
        {
            ...
            {
                // Le client est déjà enregistré. Affichez la page de fin.
                return View();
            }
            ...
            {
                // Enregistrez le client lorsque l’autorisation est octroyée.
